...
<body class="bodyStyle">
	...
	<div id="mainContent">
		...
		<div id="mainPictures" class="center">
			...
			<hr>
			<p>Du caf&eacute; offers an assortment of delicious and delectable pastries and coffees that will put a smile on your face. From cookies to croissants, tarts and cakes, each treat is especially prepared to excite your tastebuds and brighten your day!</p>
			<br>
			<table>
				<tr>
	...
	<div id="aboutUs" class="center">
		...
		<div>
			...
			<table>
				...
				<tr>
					<td><form action="Du.php" method="get">
